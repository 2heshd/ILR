...
// Voice Design identities are public IDs; the API credential stays server-side.
const REGIONAL_VOICE_IDS = Object.freeze({
  "mashhad-male": "Q67cwXM4DGFUTxUFPMrP",
  "mashhad-female": "NwpIQP70bT4UzPbnRyJo",
  "isfahan-male": "XGSEQarUapukA4X5u8jC",
  "isfahan-female": "kkZqCgSLG3Om2J1bH492",
  "shiraz-male": "HnoxgJ4BuCsGETiaCJ6k",
  "shiraz-female": "Wj2i3yxcDRQS2Bqa0P0a",
  "babol-male": "skZjuSZaNZHWMFeZXezx",
  "babol-female": "7eSeWgR0WIP4X2MxuILb",
  "ardabil-male": "rHh0WczivuxvYrO0f0M8",
  "ardabil-female": "SInHMht0XWXa75D6j7Si",
});
...
export function elevenLabsVoiceId(voice = DEFAULT_PERSIAN_VOICE_PROFILE) {
  ...
  if (profile.regionId !== "tehran") return REGIONAL_VOICE_IDS[profile.id];
