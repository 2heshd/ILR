...
export function persianRegisterIssues(value: unknown, register: "formal" | "colloquial") {
  ...
  if (register === "formal") {
    ...
    const conversationalPatterns = [
      ...
      /(?:^|[\s،,.؟!])(?:خونه|نون|اگه|واسه|می‌?خوام|می‌?رم|می‌?ریم|می‌?شه|نمی‌?شه|مهمه|باشه|اومد(?:م|ی|یم|ن|ند)?|دارن|هستن|می‌?(?:کنن|دن|شن|گن|کنه|ده|گه|ره|اد|دونه|تونه|خواد)|ب(?:خرن|رن|شن|گن|تونه)|نمی‌?(?:تونه|خواد|شه))(?=$|[\s،,.؟!])/gu,
