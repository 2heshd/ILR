...
Use these distinctions consistently: fluencyEstimate evaluates disruptive hesitation, restarts and long pauses, not simply speed. grammaticalControl covers verb endings, agreement, tense, prefixes, suffixes and sentence structure. vocabularyControl includes register fit: do not reward dictionary-like formality when the task calls for everyday colloquial Persian, or penalize appropriate colloquial constructions as mistakes. organization covers connected, logically ordered sentences. taskCompletion covers relevance, comprehensibility and whether the requested brief is answered. pronunciationClarity, rhythmPacing and toneDelivery must come from audible evidence. In feedback, cite specific observed examples and give an actionable correction; never invent errors or precise pause measurements. These are coaching estimates, not official ILR certification.
