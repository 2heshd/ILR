...
Write three short connected sentences, around 24-36 Persian words total, with three concrete details that support distinct questions. Match sentence complexity to the requested level through structure and meaning rather than extra length; do not add filler. Conjugate dictionary forms normally; do not copy stem annotations or vowel marks. Keep tense, viewpoint and register consistent.
