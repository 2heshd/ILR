...
const practiceResponseFormat = {
  ...
  schema: {
    ...
    properties: {
      ...
      textFa: { type: "string", description: "A coherent Persian passage containing four or five complete sentences and 70–85 Persian words, leaving a safe margin above the enforced 60-word minimum." },
      topic: { type: "string" },
...
Write four or five connected sentences containing 70-85 Persian words total, leaving a safe margin above the enforced 60-word minimum, with at least three concrete details that support distinct questions. Match sentence complexity to the requested level through structure and meaning rather than filler. Conjugate dictionary forms normally; do not copy stem annotations or vowel marks. Keep tense, viewpoint and register consistent.
